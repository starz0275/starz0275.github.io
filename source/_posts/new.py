...
def main():
    # 指定目标目录
    target_directory = r"D:\mycode\starz0275.github.io\source\_posts"
    ...
    file_path = r'D:\mycode\starz0275.github.io\source\_posts\suki日记存档.md'
    try:
